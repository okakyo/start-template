...
const dataProvider = (client: GraphQLClient): Required<Daimport { generateFilter, generateSort, getOperationFields, isMutation } from "../utils";
import camelCase from "camelcase";
import * as gql from "gql-query-builder";
import { GraphQLClient } from "graphql-request";
import gqlTag from "graphql-tag";
import pluralize from "pluralize";
import type { DataProvider, BaseRecord } from "@refinedev/core";taProvider> => {
  return {
