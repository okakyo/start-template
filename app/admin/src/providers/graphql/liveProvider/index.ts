...
const subscriptions = {
  ...
  useOne: generateUseOneSubimport { generateUseListSubscription, generateUseManySubscription, generateUseOneSubscription } from "../utils";
import type { LiveProvider } from "@refinedev/core";
import type { Client } from "graphql-ws";scription,
